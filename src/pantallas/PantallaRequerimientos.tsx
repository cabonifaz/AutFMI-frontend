...
import { ModalRQCreate } from "../components/ui/modals/RQcreate";
import { ModalRQDetails } from "../components/ui/modals/RQdetails";
...
export const PantallaRequerimientos = () => {
  ...
  const clientOptions: BaseOption[] = clientes
  ...
  return (
    <>
      {(loading || paramLoading || clientsLoading) && (
        ...
        <div className="flex flex-col h-screen overflow-hidden p-2">
          <div className="flex-none max-w-[95vw]">
            <h2 className="text-2xl font-semibold mb-4 flex gap-2">
              <div
                className="space-y-1 cursor-pointer ms-1 lg:hidden self-center"
                onClick={toggleMenu}
              >
            ...
            <table className="table">
              <thead className="sticky top-0 bg-white z-10">
                <tr className="table-header">
                  <th className="table-header-cell text-nowrap">
                    ID
                  </th>
                  <th className="table-header-cell text-nowrap">
                    Cliente
                  ...
                  <th className="table-header-cell text-center text-nowrap">
