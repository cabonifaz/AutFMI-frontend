...
export const ModalPostulantFiles = ({
  ...
  const { paramsByMaestro } = useParams(MAESTRO_TIPO_ARCHIVO_POSTULANTE);
  const docTypes =
    paramsByMaestro[Number(MAESTRO_TIPO_ARCHIVO_POSTULANTE)] || [];
      ...
      <div className="relative flex h-[calc(100vh-2rem)] max-h-[640px] min-h-0 w-full flex-col overflow-hidden rounded-lg bg-white p-4 shadow-lg md:w-[600px]">
        ...
        {selectedId != null && (
          <div className="flex min-h-0 flex-1 flex-col">
            ...
            >
              <Upload className="mb-2 h-6 w-6 opacity-70" />
